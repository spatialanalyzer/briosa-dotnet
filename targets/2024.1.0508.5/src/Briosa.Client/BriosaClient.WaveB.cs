...
public sealed partial class BriosaClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        var request = OperationProtocolMapper.BuildRequest(
            ...
            new Dictionary<string, object?>
            {
                ["construct_planes"] = constructPlanes,
                ["construct_cylinders"] = constructCylinders,
                ["construct_spheres"] = constructSpheres,
                ["construct_cones"] = constructCones,
                ["construct_lines"] = constructLines,
                ["construct_points"] = constructPoints,
                ["construct_circles"] = constructCircles,
            });
        return InvokeOperationAsync(
            "briosa.ConstructionOperations",
