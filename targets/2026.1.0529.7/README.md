...
./eng/Test-Conformance.ps1 -ArtifactPath C:\path\to\briosa-client-conformance-0.6.0-sa-2026.1.0529.7-win-x64.zip
...
./eng/Import-ProtocolArtifact.ps1 `
  -ArtifactPath C:\path\to\briosa-protocol-0.6.0-sa-2026.1.0529.7.zip `
  -Update `
